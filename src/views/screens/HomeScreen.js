...
import { Dimensions, SafeAreaView, TouchableOpacity, StyleSheet, View, Text, Button, ScrollView, Image, Touchable } from 'react-native'
            ...
            <View style={styles.header}>
                <View>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ fontSize: 28, fontWeight: 'bold', marginLeft: 10 }}>Akuchukwu</Text>
                    </View>
